...
def domain_input_handler(dt, model, domain_name, domain_lonlat, file, point_name, point_lonlat=None, use_latest=True,delta_index=None):
...
def domain_input_handler_oldold(dt, model, domain_name, domain_lonlat, file, point_name, point_lonlat=None, use_latest=True, delta_index=None):
  #print(point_name)
  #print(domain_name)
  #print(domain_lonlat)
  print("in dom input")
...
def domain_input_handler_old(dt, model, domain_name, domain_lonlat, file, point_name, point_lonlat=None, use_latest=True,delta_index=None):
  print("delta_index in domain handler at checkget")
  print("AINA#####################################################################")
  print(delta_index)
  #print(point_name)
