...
class get_data():
    ...
    def adjust_user_url(self):
        ...
        while i < len(list_p):
            ...
            other_dim = list(filter(re.compile(f'.*top_of_atmosphere*|.*mean_sea_level*|atmosphere_as_single_layer|surface|adiabatic_condensation_level|grib2_vLevel*').match, dimlist))
